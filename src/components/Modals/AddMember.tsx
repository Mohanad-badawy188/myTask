        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="mb-2 mt-2">
              <label className="fs14 text-secondary">User*</label>
              <select
            ...
            <div className="mb-2 mt-2">
              <label className="fs14 text-secondary">Delegator*</label>
              <select
                defaultValue={"Default"}                className="form-select shadow-none border-0 text-secondary fw-light fs14 mb-2"
                style={{ backgroundColor: "#F1F1F1" }}>
                <option value="Default" disabled>
            ...
            <div className="mb-2 mt-2">
              <label className="fs14 text-secondary">Assigned Committee*</label>
              <select
                defaultValue={"Default"}                className="form-select shadow-none border-0 text-secondary fw-light fs14 mb-2"
                style={{ backgroundColor: "#F1F1F1" }}>
                <option value="Default"  disabled>
